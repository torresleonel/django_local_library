...
class Book(models.Model):
    ...
    class Meta:
        """Metadata for Book model."""

        permissions = (('can_manage', 'Manage Books'),)
...
class BookInstance(models.Model):
    ...
    class Meta:
        """Metadata for Book Instance model."""
...
class Author(models.Model):
    ...
    class Meta:
        """Metadata for Author model."""

        ordering = ['last_name', 'first_name']
        permissions = (('can_manage', 'Manage Authors'),)
